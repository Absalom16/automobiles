  ...
  <div class="container">
   ...
   <div class="row">
    <div class="col-12 col-lg-5">
      <img class="img-fluid" src="pic 1.jpg" alt="contact us">
    </div>
    <div class="col-12 col-lg-7">  
      ...
      <form action="">
        <div class="form-floating">
          <input required type="text" class="form-control mb-3" id="floatingPassword" placeholder="Your Name">
        ...
        <div> 
         ...
         <button class="form-control mt-2 btn btn-primary">Send</button>
      </form>
     </div>
   </div>
  </div>
...
<div class="row">
    <div class="col-12 text-center">
      <a href="Contacts.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
