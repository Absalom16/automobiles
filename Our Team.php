...
<body>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link  px-3" href="services.php" >Services
                    </a>
    ...
    <section class="container-fluid py-5">
      <div class="container">
          ...
          <div class="row pt-5">
              <div class="col-12 col-lg-10 offest-lg-1">
              
              <div class="row">
                  <div class="col-12 col-lg-4">
                      <div class="card">
                          <img src="pexels-chloe-1043474.jpg" class="card-img-top" alt="">
                          <div class="card-body text-center">
                              <h4><i>M.K Tukturi</i></h4>
                              <h5>Web Developer</h5>
                              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                              </svg></i>
                  ...
                  <div class="col-12 col-lg-4">
                      <div class="card">
                          <img src="pexels-andrea-piacquadio-3778876.jpg" class="card-img-top" alt="">
                          <div class="card-body text-center">
                              <h4><i>M.K Tukturi</i></h4>
                              <h5>Web Developer</h5>
                              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                  ...
                  <div class="col-12 col-lg-4">
                      <div class="card">
                          <img src="pexels-teddy-joseph-2955375.jpg" class="card-img-top" alt="">
                          <div class="card-body text-center">
                              <h4><i>M.K Tukturi</i></h4>
                              <h5>Web Developer</h5>
                              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
...
<div class="row">
    <div class="col-12 text-center">
        <a href="Our Team.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
